...
void print_signals(){
  Serial.print("Roll:");
  if(receiver_input_channel_1 < 1480)Serial.print("<<<");
  else if(receiver_input_channel_1 > 1520)Serial.print(">>>");
  else Serial.print("-+-");
  Serial.print(receiver_input_channel_1);
  
  Serial.print("  Nick:");
  if(receiver_input_channel_2 < 1480)Serial.print("^^^");
  else if(receiver_input_channel_2 > 1520)Serial.print("vvv");
  else Serial.print("-+-");
  Serial.print(receiver_input_channel_2);
  
  Serial.print("  Gas:");
  if(receiver_input_channel_3 < 1480)Serial.print("vvv");
  else if(receiver_input_channel_3 > 1520)Serial.print("^^^");
  else Serial.print("-+-");
  Serial.print(receiver_input_channel_3);
  
  Serial.print("  Yaw:");
  if(receiver_input_channel_4 < 1480)Serial.print("<<<");
  else if(receiver_input_channel_4 > 1520)Serial.print(">>>");
  else Serial.print("-+-");
